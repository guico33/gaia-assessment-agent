        ...
        try:
            ...
            try:
                ...
                # Method 3: Direct draw method (fallback)
                    ...
                    print(f"   ❌ No PNG generation methods available on {type(drawable_graph)}")
                    print(f"   Available methods: {[attr for attr in dir(drawable_graph) if not attr.startswith('_')]}")
